...
- **Matplotlib & Seaborn** – for statistical visualization and exploration

- **Snowflake** – as a cloud-based data warehouse for scalable data storage

- **SQL** – for querying and managing datasets within Snowflake
...
## Conclusion
This project showcases how data-driven insights can be extracted from gaming data using modern analytics tools and techniques.
